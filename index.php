...
<section id="skills">
    ...
    <div class="'col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-2">
          ...
          <p>Graphic design background, proficient with the Adobe Suite</p>
        </div>
...
<section id="contact" class="module parallax parallax-4">
    ...
    <div class="col-md-3 col-md-pull-3 col-xs-6  text-center"> <img src="img/dobbsapproved.png" class="center-block img-responsive" alt=""/></div>
    <div class="col-md-3 col-md-push-1 col-xs-6 text-center"> <img src="img/dobbsapproved.png" class="center-block img-responsive" alt=""/> </div>
  </div>
      <div class="row">
