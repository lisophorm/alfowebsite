...
$image_error=$site_config['document_root'].$site_config['absolute_uri'].'/img/close.png';	// used if no image could be found, or a gif image is specified
//die($site_config['document_root'].$site_config['absolute_uri'].'/img/close.png');
$thumb_size_x = 0;
$thumb_size_y = 0;
