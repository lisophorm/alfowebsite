...
?>
  ...
  <div class="row">
    ...
    <div class="col-md-7">
      <ul class="bxslider">
        <?php
$files = glob(GetSQLValueString($colname_getcase, "int")."/*.{png,jpg,jpeg}", GLOB_BRACE);
if(count($files)>0) {
foreach ($files as $file) {
    print " <li><img src=\"portfolio/$file\"  class=\"img-responsive\" /></li>";
	//for ($i = 1; $i <= 5; $i++) {
    //print " <li><img src=\"http://lorempixel.com/800/600/?gino=".rand()."\"  class=\"img-responsive\" /></li>";
}} else {
	    print " <li><img src=\"http://dummyimage.com/800x600/0a0/fff?gino=".rand()."\"  class=\"img-responsive\" /></li>";
